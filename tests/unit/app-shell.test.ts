...
describe("app shell rendering", () => {
  ...
  it("opens a full Ritual editor shell with editable canonical body fields", async () => {
    ...
    expect(editorHtml).toContain(">Choose with me preview<");
    expect(editorHtml).toContain('data-manage-ritual-choose-preview-form="true"');
    expect(editorHtml).toContain('name="previewEnergyCapacity"');
    expect(editorHtml).toContain('name="previewAudience"');
    expect(editorHtml).toContain('name="previewPurpose"');
    expect(editorHtml).toContain('name="previewCarrier"');
    expect(editorHtml).toContain('name="previewTiming"');
    expect(editorHtml).toContain("Eligible for this sample");
    expect(editorHtml).toContain("Why this fits");
    expect(editorHtml).toContain("How this was chosen");
    expect(editorHtml).toContain("Fit details");
    expect(editorHtml).toContain("Timing");
    expect(editorHtml).not.toContain("required_timing_unmatched");
    expect(editorHtml).not.toContain("selectedBreakdown");
