# Source rite inventory and extraction repair: The House Witch

## Repair metadata

Repair packet ID: `repair-house-witch-source-inventory`

Repairs packet: existing draft House Witch extraction packet from #278

Source ID: `SRC-MOD-HOUSE-MURPHYHISCOCK-2018`

Source: Arin Murphy-Hiscock, *The House Witch: Your Complete Guide to Creating a Magical Space with Rituals and Spells for Hearth and Home*

Mode: extraction repair / inventory backfill

Date: 2026-06-09

Runtime status: no runtime approval

Candidate status rule: all existing and future candidates remain `draft`, unavailable, not findable, not direct-use eligible, not recommendation eligible, and not recommendable.

## Existing packet reviewed

Existing draft House Witch extraction packet from #278 reviewed conceptually.

Existing candidates reconciled:
...
Approved with limits for:

- hearth and home tending mechanics;
- home-as-sacred-space framing;
- kitchen/table spirituality;
- sacred flame / candle / oil lamp mechanics;
- cauldron and vessel mechanics;
- doorway and threshold cleansing/protection mechanics;
- home, room, hearth, cauldron, candle, fuel, and object blessing structures;
- spoken magic and personally authored words;
...
## Approved source ranges used

All page references use the uploaded PDF/source file.

Approved source ranges used:

- Front matter / TOC: PDF pp. 1–6
- Introduction: PDF pp. 7–8
- Chapter 1, A Place to Call Home: PDF pp. 9–25
- Chapter 2, Your Home As a Sacred Space: PDF pp. 26–38
- Chapter 3, Your Spiritual Hearth: PDF roughly pp. 39–60
- Chapter 4, The Magic of the Cauldron: PDF roughly pp. 61–82
- Chapter 6, The Kitchen As a Sacred Space: PDF roughly pp. 83–98
- Chapter 7, Using Hearthcraft to Protect Your Home: PDF pp. 99–121
- Chapter 8, Magic at the Hearth: PDF pp. 122–138
- Chapter 9, The Spirituality of Food: PDF pp. 139–152
- Chapter 10, Herbs, Crafts, and Other Hearth-Related Magic Work: PDF pp. 153–172
- Chapter 11, Spells and Rituals: PDF pp. 173–183
- Appendix / bibliography / index: PDF pp. 184–200, context only

## Excluded/held ranges respected

This repair does not reopen source-gate decisions.

Excluded or held by default:

- direct deity/spirit practice unless Tim separately approves deity/spirit extraction;
- genericized smudging or culturally specific living practices;
- guaranteed protection/purification/healing/outcome claims;
- medical, nutritional, or therapeutic claims;
- unsafe herb, smoke, oil, flame, cauldron, or food practices;
- full authored rituals/prayers/spells/recipes/prompts/meditations/invocations generated into the packet;
...
hold: 8
reject: 0
remaining_unreviewed_source_sections: none known within approved House Witch extraction scope
remaining_extraction_backlog: 17 candidate_extract_later items plus 8 hold items requiring product/source-boundary decisions
```
...
The repair inventory found 58 source items. The source inventory is deeper than the original 11-candidate extraction packet and demonstrates substantial remaining yield.

### Candidate extract now

These inventory items support the existing 11 draft candidates:
...
Some candidate records draw from more than one source item, which is why the number of source items supporting current candidates is greater than the current candidate count.

### Candidate extract later

Backlog items include:

- Hearth values / sacred definition prompt
- Household values table rite
- Chosen-family care rite
- Kitchen shrine tending
- Kitchen mindfulness practice
- Table blessing / food gratitude
- Recipe-specific ritual candidates
- Imagined hearth meditation
- Access hearth energy
- Room purification
- Room blessing
- Personal purification
- Creating sacred space
- Consecrating candles/fuel
- Cauldron-based rite
- Appliance/tool blessing
- Seasonal honoring craft
- Herb waters / washes
- Other magical recipes

### Source note only

Source-note-only material includes:

- Introduction / home as refuge
- Hearthcraft definition
- Ritual simplicity / intuitive ceremony
- Everyday things can be magical
- Sacred home / threshold customs
- Sacred hearth/fire symbolism
- What is a cauldron?
- Cauldrons in mythology
- Cauldron types/care
- Kitchen as sacred space
- Home protection philosophy
- Protective plants/stones
- Purification technique categories
- Everyday objects / tools
- Kitchen folklore
- Food energy
- Herb magic context
- Appendix ingredients/supplies
- Bibliography/index
...
- Needfire / cauldron alcohol fire
- Smudging as named/generic practice
- Corn husk doll / kitchen witch icon
- Magical figures and symbols
- Direct recipe reproduction
- Generic correspondence import
- Unsafe cauldron/fire use without review

Medical/healing/nutrition claims and guaranteed protection/purification/healing outcomes are rejected if encountered.
...
| `ritual-house-witch-spell-bottle-household-vessel` | Make a Household Spell Bottle | Spell Bottles | keep / later split | Strong vessel/protection candidate. | Flag future splits: protection bottle, blessing bottle, remembrance bottle, seasonal marker bottle, threshold bottle. |
...
| Room blessing | Room Blessing | `candidate_extract_later` | plant/vessel + blessing | Future single-room variant. |
| Personal purification | Personal Purification | `candidate_extract_later` | body + releasing/blessing | Strong body lane. |
| Creating sacred space | Creating Sacred Space | `candidate_extract_later` | body/words + opening | Strong general opening candidate. |
| Consecrating candles/fuel | Consecrating Candles or Fuel | `candidate_extract_later` | candlelight + blessing | Useful for candle source stack. |
| Cauldron-based rite | Cauldron-Based Spells and Rites | `candidate_extract_later` | vessel + blessing/steadying | Could extend cauldron candidate. |
...
| --- | --- | --- | --- |
| Hearth and home deities | Ch. 5 | hold | Deity/cosmology not approved by default. |
| Household spirits | Ch. 5 | hold | Spirit practice needs Tim decision. |
| Incorporating your ancestors | Ch. 3 | hold | Ancestor/grief/spirit decision needed. |
| Needfire / cauldron alcohol fire | Ch. 2, PDF pp. 33–35 | hold | High fire risk; separate safety review. |
...
| Unsafe cauldron/fire use without review | Needfire / oil lamp / cauldron | hold/reject depending use | Adult-use caution required; high-risk fire held. |

## Coverage implications

| Cell | Existing support | Inventory repair implication |
| --- | --- | --- |
| candlelight + opening | strong | Kitchen sacred flame, lighting lamp/candle, hearth blessing, sacred-space creation. Oil lamp/candle split likely later. |
| candlelight + steadying | strong | Banked inner flame, imagined hearth, sacred hearth, cauldron focus. |
| candlelight + blessing | strong | Hearth blessing, cauldron blessing, house blessing, room blessing, candle/fuel consecration. |
| table + tending | strong | Kitchen tending, food preparation, kitchen shrine, household grimoire, spiritual hearth. |
| table + connecting | moderate/strong | Food-with-awareness, chosen family care, values exercises, table blessings. |
| doorway + protecting | strong | Threshold boundary, doorstep cleansing, house blessing, door/window frames. |
...
| body + steadying | moderate/strong | Bank inner flame, kitchen mindfulness, imagined hearth, sacred space. |
| remembering via ancestor/spirit practice | held | Source supports it, but Tim must approve ancestor/spirit lane before extraction. |
| deity/spirit invocation | held | Present but not approved by default. |
| smudging/smoke as named practice | held | Smoke mechanics can be used carefully; genericized smudging held. |

## Duplicate / mechanic implications

| Mechanic cluster | Candidates affected | Implication |
| --- | --- | --- |
| Hearth recognition vs kitchen flame | `spiritual-hearth-recognition`, `kitchen-sacred-flame` | Keep distinct. Hearth recognition is root/place-setting; kitchen flame opens work. |
| Spiritual hearth vs imagined hearth | `spiritual-hearth-recognition`, future imagined hearth | Existing candidate should not absorb all inner-hearth meditation material. |
| Bank inner flame vs personal purification | `bank-the-inner-flame`, future personal purification | Keep distinct: close-of-day protection vs symbolic purification. |
| Threshold wash vs house blessing circuit | `threshold-wash`, `house-blessing-circuit` | Keep distinct. Threshold wash is focused doorway cleansing; house blessing is full-house circuit. |
| House blessing vs room blessing | `house-blessing-circuit`, future room blessing | Split later. Current candidate should remain full-house. |
| Cauldron blessing vs spell bottle | `cauldron-blessing`, `spell-bottle-household-vessel` | Keep distinct. Cauldron is hearth vessel; spell bottle is sealed purpose vessel. |
| Food awareness vs recipe storage | `food-with-awareness`, `household-grimoire-entry` | Keep distinct. Food awareness is practice; grimoire entry records and preserves. |
...
6. Exact words must be preserved as ritual material. Do not reproduce long passages, but do flag exact wording locations.
7. Avoid over-secularizing. The source is explicitly witchcraft/hearthcraft.
8. Safety should stay concise. Ordinary adult use is not a blocker; flag practical cautions.

## Open questions for Tim

1. Should `Spiritual Hearth Recognition` be treated as Moon & Table’s root household practice, or just one candidate among many?
2. Should `Bank the Inner Flame` be bedtime-specific, or a general close-of-day practice?
3. Should `Kitchen Sacred Flame` later split into candle and oil-lamp variants?
4. Should `Threshold Wash` later split into indoor threshold, outdoor doorstep, and window/door-frame variants?
5. Should `House Blessing Circuit` later split into full-house blessing, room blessing, threshold-only blessing, and pre-hosting/post-conflict reset?
6. Are non-cauldron bowls/jars acceptable adaptations for `Cauldron Blessing`, or should they become separate variants?
7. Should `Spoken Hearth Words` become a reusable verbal layer inside many rituals, not just a standalone candidate?
8. Should exact recipe storage become its own Moon & Table content type?
9. Should `Household Grimoire Entry` be both a Ritual candidate and a standard post-ritual follow-up?
10. Should smudging be avoided as product language while preserving smoke/incense mechanics under different wording?
11. Should ancestor/remembrance material move forward in a separate packet, or remain held until a spirit/ancestor policy is approved?
12. Should deity/household spirit material remain permanently context-only?
13. Should `Spell Bottle` split into protection, blessing, remembrance, seasonal marker, and threshold bottle variants in the next extraction batch?

## Final decision

`inventory_backfilled_ready_for_review`

The House Witch source inventory is now backfilled enough for human review as a research artifact.

The existing 11 candidates are still draft-only and remain unavailable, not findable, not direct-use eligible, not recommendation eligible, and not recommendable.
