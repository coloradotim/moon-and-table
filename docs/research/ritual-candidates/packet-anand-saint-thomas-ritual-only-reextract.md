...
| Sexual power objects and gendered organ symbolism | PDF 51-68 | ritual material | source_note / ritual_candidate | explicit, cultural_or_gender_load, house_voice_challenge | table, body | opening, marking | hold_before_import | yes | Source support is real, but the current app model needs an explicit product decision before importing overt organ-symbol material. | Decide reject, source-note-only, or private-household-only. |
...
| Divine feminine / divine masculine rites | Ch. 3 pp. 73-75 | blessing / meditation | ritual_candidate | cultural_or_gender_load, exact_text_sensitive, house_voice_challenge | words, body | blessing, opening | hold_before_import | yes | Source lane is visible; gendered metaphysics need product and voice review. | Decide reject/source-note-only/later candidate. |
...
| Venus powder / attraction powder | Ch. 4 | recipe / glamour | ritual_candidate | medical_or_somatic_claim, coercive_or_target_control, house_voice_challenge | plant, vessel | opening, blessing | hold_before_import | yes | Recipe and attraction framing need review. | Decide reject/source-note-only/later non-targeted glamour. |
...
| Play party goal/boundary material | Ch. 5 pp. 106-108 | planning rite | ritual_candidate | kink_adjacent, explicit, consent_sensitive, technique_heavy, house_voice_challenge | words, body | protecting, voicing | hold_before_import | yes | Event/social safety and app-fit decisions are unresolved. | Decide reject, source-note-only, or private adult pointer. |
...
| Relationship format tarot | Ch. 6 pp. 129-131 | divination prompt | context / ritual_candidate | adult_intimacy, exact_text_sensitive | words, table | voicing, connecting | source_note_only | yes | More diagnostic spread than self-contained Ritual under current model. | Decide later if tarot-prompt content type exists. |
...
| Intercultural relationship and family/social glamour | Ch. 6 pp. 134-138 | protection / glamour | ritual_candidate | cultural_or_gender_load, therapy_adjacent, house_voice_challenge | words, candlelight, body | protecting, blessing | candidate_extract_later | yes | Deferred for sensitivity and product fit. | Later review or reject. |
...
| Love necromancy / relationship revival | Ch. 6 pp. 140-141 | spell | ritual_candidate | coercive_or_target_control, therapy_adjacent, house_voice_challenge | candlelight, words | opening, connecting | hold_before_import | yes | Source lane is visible but pressure/control risk is high. | Decide reject or source-note-only. |
...
| Wedding / commitment doll work | Ch. 6 pp. 147-148 | object rite | ritual_candidate | adult_intimacy, exact_text_sensitive, house_voice_challenge | table, words | marking, blessing | candidate_extract_later | yes | Could be a commitment marker, but was not source-safely authored here. | Later candidate or hold. |
| Sex worker protection prayer | Ch. 7 pp. 154-155 | prayer | ritual_candidate | cultural_or_gender_load, exact_text_sensitive, house_voice_challenge | words, candlelight | protecting, blessing | hold_before_import | yes | Community-specific prayer needs product/voice review before app content. | Decide reject, source-note-only, or later private review. |
...
| Psychic vampire / energy-drain boundary lane | Ch. 7 pp. 160-165 | protection / boundary | ritual_candidate | therapy_adjacent, house_voice_challenge, exact_text_sensitive | words, body, candlelight | protecting, releasing | candidate_extract_later | yes | Source lane is visible but needs house-voice and product-boundary handling before becoming app content. | Later source-safe boundary candidate or source-note-only. |
...
| Chapter 8 mirror-bed banishing / identity-protection hex lanes | Ch. 8 pp. 166-169 | hex / protection | ritual_candidate | coercive_or_target_control, house_voice_challenge, exact_text_sensitive | candlelight, body, words | protecting, releasing | hold_before_import | yes | Some ritual architecture exists, but chapter frame and exact-source handling need Tim decision. | Decide reject, source-note-only, or mechanics-only salvage. |
| Chapter 8 money/rebound/revenge attraction lanes | Ch. 8 pp. 169-171 | spell / recipe | ritual_candidate | coercive_or_target_control, explicit, sex_forward, body_fluid, medical_or_somatic_claim | vessel, body, candlelight | opening, protecting | reject_product_boundary | yes | Targeted/revenge/body-fluid recipe handling blocks import. | Name only; do not import from this packet. |
| Chapter 8 slut-shamer / psychic truth / breakup courage lanes | Ch. 8 pp. 171-174 | spell / tarot / fire rite | ritual_candidate | coercive_or_target_control, exact_text_sensitive, house_voice_challenge | words, candlelight, table | protecting, releasing, voicing | hold_before_import | yes | Some mechanics resemble boundary/release work, but revenge frame and exact-text sensitivity are unresolved. | Decide mechanics-only non-revenge salvage vs reject. |
| Chapter 8 assault/revenge jar / karma / cemetery-fruit lanes | Ch. 8 pp. 175-177 | hex / revenge | ritual_candidate | coercive_or_target_control, therapy_adjacent, exact_text_sensitive, house_voice_challenge | vessel, plant, words | protecting, releasing | reject_product_boundary | yes | Strong revenge/trauma boundary. Visible in inventory, not import-ready. | Final reject or source-note-only decision later. |
...
| Assault survivor / cheating / gaslighting lanes | Ch. 9 pp. 185-192 | prayer / clarity / recovery | ritual_candidate | therapy_adjacent, exact_text_sensitive, house_voice_challenge | words, candlelight, body | protecting, releasing, tending | hold_before_import | yes | Source lanes are visible, but therapy/trauma product decisions and exact-text review are required. | Decide reject, source-note-only, or private direct-source-only. |
...
- All source-visible rows that had been marked tentative were promoted to `ritual_candidate` after Tim review; their dispositions still record whether they are approved, held, deferred, duplicated, or rejected for import.
