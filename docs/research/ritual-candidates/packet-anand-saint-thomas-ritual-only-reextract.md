...
Items may be complete enough to exist in search later without being direct-use eligible or recommendation eligible. Items marked `approved_for_mechanical_import` are the only rows intended for later #287-style mechanical import from this packet. All other rows are inventory-visible but intentionally blocked, deferred, duplicated, or held for Tim/product decision.
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Practice cadence and partner commitment | PDF 18-23 | practice container | source_support | adult_intimacy | words, table | connecting, tending | duplicate_existing_candidate | no | Already extracted into low-pressure practice-night and connection records. | No new import. |
| Boundaries, discomfort, and not pushing past readiness | PDF 21-23 | practice container | source_note | adult_intimacy, consent_sensitive | words | protecting, steadying | source_note_only | no | Process support for adult lanes, not a standalone Ritual. | Preserve as reviewer context. |
| Magic Circle setup with altar, candle, markers, purpose, and close | PDF 51-68 | ritual | ritual_candidate | adult_intimacy, exact_text_sensitive, cultural_or_gender_load | table, candlelight, words | opening, marking | duplicate_existing_candidate | yes for closer-source variant | Current runtime already has softened circle/table records. A closer-source form would need exact-word and gender-language review. | Optional later closer-source packet. |
| Sexual power objects and gendered organ symbolism | PDF 51-68 | ritual material | source_note / possible_candidate | explicit, cultural_or_gender_load, house_voice_challenge | table, body | opening, marking | hold_before_import | yes | Source support is real, but the current app model needs an explicit product decision before importing overt organ-symbol material. | Decide reject, source-note-only, or private-household-only. |
| Melting Hug | PDF 68-69 | exercise / ritual | ritual_candidate | adult_intimacy, consent_sensitive | body, words | connecting, steadying | metadata_repair_needed | yes | Existing record is complete, but the source function is more connection-forward than the current primary `body + steadying` metadata. | Later metadata repair or leave as-is by decision. |
| Heart Salutation | PDF 68-69 | exercise / ritual | ritual_candidate | adult_intimacy, cultural_or_gender_load | body, words | blessing, connecting | metadata_repair_needed | yes | Existing record is complete as `body + blessing`; a connection variant may be warranted but would duplicate the source mechanic. | Decide split vs current metadata. |
| Remembering times of magic | PDF 69-73 | prompt rite | ritual_candidate | adult_intimacy, exact_text_sensitive | words, table | remembering, connecting | duplicate_existing_candidate | no | Already extracted as a source-safe reflection/connection record. | No new import. |
| Inner magician initiation | PDF 73-80 | guided rite | ritual_candidate | exact_text_sensitive, cultural_or_gender_load, house_voice_challenge | words, body, table | marking, opening | candidate_extract_later | yes | Long guided structure and identity language need a separate house-voice adaptation. | Later private marking/opening candidate if wanted. |
| Anchoring the magical state | PDF 129-135 | body exercise | ritual_candidate | adult_intimacy, technique_heavy, therapy_adjacent | body, words | steadying, opening | candidate_extract_later | yes | Ritual architecture is visible, but current packet does not have a source-safe non-technique form. | Later grounding/body anchor candidate. |
| Partner movement / witnessed dance | PDF 136-144 | partner rite | ritual_candidate | adult_intimacy, explicit, sex_forward, consent_sensitive, technique_heavy, house_voice_challenge | body, words | connecting, opening, blessing | approved_for_mechanical_import | no | Source supports a complete body/witness container when stripped of performance instruction. | Approved candidate below. |
| Shame / wound processing rite | PDF 145-166 | guided rite | possible_candidate | therapy_adjacent, exact_text_sensitive, medical_or_somatic_claim, house_voice_challenge | words, body | releasing, tending | hold_before_import | yes | Source lane is real, but it asks for trauma/therapy product decisions and careful exact-word handling. | Decide reject, source-note-only, or later private review. |
| Laughing pelvis / explicit body laughter | PDF 172-179 | movement rite | ritual_candidate | adult_intimacy, explicit, technique_heavy, house_voice_challenge | body | releasing, opening | candidate_extract_later | yes | Existing softened laughter record does not represent the explicit body lane. Source-safe adaptation is possible but needs Tim voice/product decision. | Later body/releasing variant if approved. |
| Fire Meditation | PDF 180-186 | movement / visualization | ritual_candidate | technique_heavy, exact_text_sensitive, cultural_or_gender_load | body, candlelight | marking, opening | candidate_extract_later | yes | Long source sequence and visualization cannot be imported mechanically from this pass. | Later adapted movement/marking candidate or source-note-only. |
| Wild animal practice | PDF 187-195 | movement / role exercise | possible_candidate | explicit, cultural_or_gender_load, technique_heavy, house_voice_challenge | body | opening, releasing | hold_before_import | yes | Source lane is visible but house-voice and role-play handling are unresolved. | Decide reject, direct-source-only, or later private candidate. |
| Solo vision and Magic Symbol work | PDF 214-232 | symbol rite | ritual_candidate | adult_intimacy, exact_text_sensitive | table, words | opening, voicing, marking | duplicate_existing_candidate | no | Existing records already cover desire, symbol, and altar/table architecture. | No new import. |
| New relationship vision | PDF 233-237 | vision rite | possible_candidate | adult_intimacy, coercive_or_target_control, exact_text_sensitive | words, table | opening, connecting | hold_before_import | yes | New-lover manifestation can become target-control if imported carelessly. | Decide non-targeted opening-only adaptation vs reject/source-note-only. |
| Shared love vision and shared Magic Symbol | PDF 238-242 | partner symbol rite | ritual_candidate | adult_intimacy, consent_sensitive, exact_text_sensitive | words, table, body | connecting, marking | duplicate_existing_candidate | yes for body variant | Existing records preserve the symbol/connection lane; body-primary version is split-worthy but not required to avoid missing content. | Decide later metadata/body variant. |
| Making love with the Magic Symbol | PDF 243-249 | partner body rite | ritual_candidate | explicit, sex_forward, adult_intimacy, technique_heavy, consent_sensitive, direct_source_only_candidate | body, table, words | connecting, opening, marking | approved_for_mechanical_import | no | Source supports a high-level partner Ritual without reproducing technique instruction. | Approved candidate below. |
| Chakra Rub atmosphere/materials | PDF 270-277 | body/material exercise | possible_candidate | explicit, technique_heavy, medical_or_somatic_claim, cultural_or_gender_load, exact_text_sensitive | body, plant, vessel | connecting, steadying, opening | hold_before_import | yes | Ritual-shaped, but oil/chakra/somatic claims and exact sequence are not import-ready. | Decide source-note-only, reject, or later non-claim adaptation. |
| Chakra Breathing / Chakra Wave | PDF 278-310 | body / breath exercise | possible_candidate | technique_heavy, cultural_or_gender_load, medical_or_somatic_claim, exact_text_sensitive | body | steadying, opening, connecting | hold_before_import | yes | Strong body practice but too sequence-heavy and claim-sensitive for this import packet. | Later review only if wanted. |
| Chapters 7-8 explicit partner pleasuring lessons | PDF 312-410 | technique lesson | direct_source_only_candidate | explicit, sex_forward, technique_heavy, consent_sensitive, medical_or_somatic_claim, house_voice_challenge | body | connecting | reject_architectural | yes | The material is visible and valuable, but it is technique pedagogy rather than a self-contained Moon & Table Ritual unless wrapped by a separate container. | Do not import as app instruction from this packet. |
| Channeling orgasmic energy with partner | PDF 411-420 | partner energy rite | possible_candidate | explicit, sex_forward, technique_heavy, cultural_or_gender_load, medical_or_somatic_claim, exact_text_sensitive | body, words | connecting, marking | hold_before_import | yes | Strong source support, but depends on explicit energetic technique and exact claims. | Decide direct-source-only or later high-level private candidate. |
| Sexual self-empowerment with a symbol | PDF 421-429 | symbol/body rite | ritual_candidate | adult_intimacy, explicit, sex_forward, exact_text_sensitive | body, words, table | opening, voicing, connecting | approved_for_mechanical_import | no | Source supports symbol/body magic at high level; approved form avoids exact technique and claims. | Approved candidate below. |
| Magical Congress classical/spontaneous container | PDF 430-462 | culminating partner rite | ritual_candidate | adult_intimacy, explicit, sex_forward, consent_sensitive, technique_heavy, cultural_or_gender_load, exact_text_sensitive | body, candlelight, table, words, vessel | connecting, marking, steadying | approved_for_mechanical_import | no | Source supports a high-level Ritual container if the explicit sequence is not reproduced as technique instruction. | Approved candidate below. |
| Ongoing symbol practice and integration | PDF 375-390; 463-474 | follow-up pattern | product_followup_pattern | adult_intimacy | words, table, body | remembering, tending | duplicate_existing_candidate | no | Existing symbol-memory and integration records cover this as non-import-new support. | No new import. |

### Saint Thomas complete ledger

| Source item / lane | Source pages | Type | Research use | Review labels | Likely carriers | Likely purposes | Disposition | Tim decision needed? | Reason | Future action |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Chapter 1 circle/candle/altar baseline | Ch. 1 | ritual method | source_support | exact_text_sensitive | candlelight, table, words | opening, marking | duplicate_existing_candidate | no | Existing Saint Thomas records already use candle, altar, and spoken/written spell architecture. | No new import. |
| Bodily-fluid correspondences | Ch. 1 pp. 28-29; Ch. 5 pp. 105-106 | correspondence / material | source_support | adult_intimacy, explicit, body_fluid, sex_forward, house_voice_challenge | body, candlelight, words | voicing, opening, connecting | source_support_for_approved_candidate | yes before direct use | Source supports body-fluid material as ritual material, but the correspondence row is not itself a Ritual. | Supports the approved sigil/candle candidate below; no separate import. |
| Herbs, oils, crystals, and general correspondences | Ch. 1 | source material | source_support | medical_or_somatic_claim, exact_text_sensitive | plant, vessel, candlelight | blessing, protecting, opening | source_note_only | no | Useful for source grounding but not standalone Rituals. | Preserve as packet source support. |
| Chapter 2 sex education and anatomy overview | PDF 59-69 | context | context_only | explicit, medical_or_somatic_claim, technique_heavy | body, words | connecting, protecting | reject_architectural | yes | Useful reviewer context, but not a Ritual and not Moon & Table instruction. | Keep out of app content unless a later non-Ritual content type exists. |
| Chapter 2 consent, kink, and relationship-format glossary | PDF 59-69 | context | source_note | explicit, kink_adjacent, consent_sensitive, medical_or_somatic_claim | words | protecting, connecting | source_note_only | yes | Helps reviewers avoid coy extraction, but should not become app-facing instruction in the Ritual model. | Reviewer context only. |
| Gender identity rite | Ch. 3 pp. 72-73 | blessing / meditation | ritual_candidate | cultural_or_gender_load, exact_text_sensitive, house_voice_challenge | words, body | blessing, voicing | candidate_extract_later | yes | Potentially ritual-shaped but needs sensitivity and exact-word review. | Later identity/blessing candidate if wanted. |
| Divine feminine / divine masculine rites | Ch. 3 pp. 73-75 | blessing / meditation | possible_candidate | cultural_or_gender_load, exact_text_sensitive, house_voice_challenge | words, body | blessing, opening | hold_before_import | yes | Source lane is visible; gendered metaphysics need product and voice review. | Decide reject/source-note-only/later candidate. |
| Solo erotic self-practice | Ch. 3 pp. 75-76 | body rite | possible_candidate | explicit, sex_forward, technique_heavy, direct_source_only_candidate | body | connecting, opening | hold_before_import | yes | Body ritual lane is visible but current packet cannot author it without importing technique instruction. | Decide direct-source-only, private-household-only, or reject. |
| Psychoactive self-love / flying ointment / topical recipes | Ch. 3 pp. 77-89 | recipe | source_support | explicit, medical_or_somatic_claim, technique_heavy, house_voice_challenge | plant, body, vessel | opening, blessing | reject_product_boundary | yes | Recipe/material and psychoactive boundaries make this unsuitable for mechanical import. | Likely reject app text; source-note-only if Tim wants. |
| Targeted partner summoning | Ch. 4 pp. 91-93 | spell | possible_candidate | coercive_or_target_control, explicit, sex_forward | candlelight, words | opening, connecting | hold_before_import | yes | Source lane is real but targeted attraction conflicts with current import assumptions. | Decide reject, source-note-only, or mechanics-only non-targeted salvage. |
| Obsession oil / enthrallment powder | Ch. 4 pp. 94-97 | recipe / spell | possible_candidate | coercive_or_target_control, body_fluid, explicit, medical_or_somatic_claim | plant, vessel, body | opening, connecting | reject_product_boundary | yes | Target-control and recipe/body-fluid handling block import. | Name only; do not import from this packet. |
| Baby gay / sexual becoming spell | Ch. 4 | rite | ritual_candidate | adult_intimacy, cultural_or_gender_load, house_voice_challenge | words, body | opening, blessing | candidate_extract_later | yes | Potentially useful and source-backed, but not re-authored in this pass. | Later sensitivity/voice review. |
| Venus powder / attraction powder | Ch. 4 | recipe / glamour | possible_candidate | medical_or_somatic_claim, coercive_or_target_control, house_voice_challenge | plant, vessel | opening, blessing | hold_before_import | yes | Recipe and attraction framing need review. | Decide reject/source-note-only/later non-targeted glamour. |
| Scarlet soak / body confidence bath | Ch. 4 | bath rite | ritual_candidate | adult_intimacy, medical_or_somatic_claim | vessel, body | blessing, opening | duplicate_existing_candidate | no | Existing record preserves body confidence/bath logic. | No new import. |
| First date glamour | Ch. 4 | glamour rite | ritual_candidate | adult_intimacy, sex_forward, house_voice_challenge | candlelight, words, body | opening, blessing | duplicate_existing_candidate | yes for metadata | Existing record is safe; metadata may need franker desire/social context. | Metadata review later if wanted. |
| Demons tarot / hesitation check | Ch. 4 | divination prompt | ritual_candidate | adult_intimacy, exact_text_sensitive | words, table | opening, voicing | duplicate_existing_candidate | no | Existing record covers the self-check. | No new import. |
| Just-sex boundary ritual | Ch. 4 pp. 101-102 | words rite | ritual_candidate | adult_intimacy, explicit, consent_sensitive, sex_forward | words, body | connecting, protecting | duplicate_existing_candidate | yes for recommendation posture | Existing record is a good explicit adult direct-use/search lane. | Decide recommendation constraints later. |
| Sex positivity prayer | Ch. 5 pp. 103-104 | prayer | ritual_candidate | adult_intimacy, explicit, sex_forward, exact_text_sensitive | words, candlelight | blessing, voicing | duplicate_existing_candidate | no | Existing candidate captures the blessing/voice architecture without copied prayer. | No new import. |
| Erotic sigil | Ch. 5 pp. 104-106 | sigil rite | ritual_candidate | adult_intimacy, explicit, sex_forward, exact_text_sensitive | words, table, body | voicing, marking | duplicate_existing_candidate | no | Existing sigil record covers the main architecture. | No new import. |
| Body-fluid sigil candle variant | Ch. 5 pp. 105-106 | sigil/body material rite | ritual_candidate | adult_intimacy, explicit, body_fluid, sex_forward, house_voice_challenge | body, candlelight, words | voicing, opening, connecting | approved_for_mechanical_import | yes before direct use | Prior extraction under-named the body-fluid variant; this packet makes it import-ready only as draft/findable. | Approved candidate below. |
| Play party goal/boundary material | Ch. 5 pp. 106-108 | planning rite | possible_candidate | kink_adjacent, explicit, consent_sensitive, technique_heavy, house_voice_challenge | words, body | protecting, voicing | hold_before_import | yes | Event/social safety and app-fit decisions are unresolved. | Decide reject, source-note-only, or private adult pointer. |
| Kink clarity candle/rope rite | Ch. 5 pp. 108-110 | candle/body rite | ritual_candidate | adult_intimacy, explicit, kink_adjacent, consent_sensitive | candlelight, words, body | voicing, opening | duplicate_existing_candidate | no | Existing record covers the candle/words architecture. | No new import. |
| Kink shame-release body variant | Ch. 5 pp. 108-110 | body/word rite | ritual_candidate | adult_intimacy, explicit, kink_adjacent, consent_sensitive, technique_heavy | body, candlelight, words | voicing, opening, connecting | approved_for_mechanical_import | no | Source supports a complete symbolic body/word form without teaching rope technique. | Approved candidate below. |
| Massage oil / intimacy oil | Ch. 5 pp. 110-111 | recipe | source_support | explicit, medical_or_somatic_claim, technique_heavy | plant, vessel, body | connecting, blessing | reject_product_boundary | yes | Recipe/material safety and exact proportions make this non-importable as a Ritual. | Source-note-only at most. |
| Anal technique / explicit technique instruction | Ch. 5 pp. 111-113 | technique lesson | direct_source_only_candidate | explicit, technique_heavy, medical_or_somatic_claim | body | connecting | reject_architectural | yes | Valuable source content, but it is technique instruction rather than a self-contained Ritual. | Do not import as app text. |
| Fantasy apple | Ch. 5 pp. 113-115 | object rite | ritual_candidate | adult_intimacy, explicit, sex_forward | table, plant, words | opening, voicing | duplicate_existing_candidate | no | Existing apple/fantasy candidate preserves the ritual logic. | No new import. |
| Toy consecration / object preparation | Ch. 5 pp. 115-116 | object rite | ritual_candidate | adult_intimacy, explicit, exact_text_sensitive | table, body, words | blessing, marking | duplicate_existing_candidate | yes for direct-use posture | Existing record covers object blessing. | Decide search/direct-use posture later if needed. |
| Hot sex incense / psychic sex smoke | Ch. 5 pp. 116-118 | recipe / smoke | source_support | explicit, medical_or_somatic_claim, technique_heavy | plant, vessel, body | opening, connecting | reject_product_boundary | yes | Smoke/recipe and somatic claims block import. | Source-note-only if retained. |
| Fantasy rose | Ch. 5 pp. 118-120 | object/plant rite | ritual_candidate | adult_intimacy, explicit, sex_forward | plant, words, table | opening, voicing | duplicate_existing_candidate | no | Existing record preserves fantasy/object ritual logic. | No new import. |
| Threesome / third-party invitation lane | Ch. 5 pp. 120-121 | planning rite | possible_candidate | explicit, consent_sensitive, kink_adjacent, house_voice_challenge | words, body, table | connecting, opening | hold_before_import | yes | Third-party consent/product fit requires explicit decision. | Decide reject, source-note-only, or private-household-only. |
| Partner sex magic | Ch. 5 pp. 121-122 | partner rite | ritual_candidate | explicit, sex_forward, adult_intimacy, consent_sensitive, direct_source_only_candidate | body, candlelight, words | connecting, marking | approved_for_mechanical_import | no | Existing record uses candlelight as primary; source also supports a high-level body+connecting variant. | Approved candidate below. |
| Dry spell / desire rekindling | Ch. 5 pp. 122-123 | candle/water rite | ritual_candidate | adult_intimacy, explicit, sex_forward | candlelight, vessel, words | opening, connecting | duplicate_existing_candidate | yes for recommendation posture | Existing record exists; desire/recommendation constraints may need review. | No new import. |
| Makeup sex / repair lane | Ch. 5 pp. 124-125 | partner rite | ritual_candidate | adult_intimacy, explicit, sex_forward, consent_sensitive | body, words, candlelight | tending, connecting | duplicate_existing_candidate | yes for metadata | Existing runtime shifted repair toward `tending`; connection remains a possible split. | Metadata review later. |
| Aftercare ointment | Ch. 5 pp. 127-128 | recipe | source_support | explicit, medical_or_somatic_claim, technique_heavy | plant, vessel, body | steadying, tending | reject_product_boundary | yes | Recipe/material boundary blocks import. | Source-note-only if retained. |
| Relationship format tarot | Ch. 6 pp. 129-131 | divination prompt | context / possible_candidate | adult_intimacy, exact_text_sensitive | words, table | voicing, connecting | source_note_only | yes | More diagnostic spread than self-contained Ritual under current model. | Decide later if tarot-prompt content type exists. |
| Jealousy, forgiveness, and clear communication lanes | Ch. 6 pp. 132-136 | spell / prompt rite | ritual_candidate | adult_intimacy, therapy_adjacent, exact_text_sensitive | words, candlelight | tending, voicing, releasing | duplicate_existing_candidate | no | Existing safe relationship records cover these. | No new import. |
| Intercultural relationship and family/social glamour | Ch. 6 pp. 134-138 | protection / glamour | possible_candidate | cultural_or_gender_load, therapy_adjacent, house_voice_challenge | words, candlelight, body | protecting, blessing | candidate_extract_later | yes | Deferred for sensitivity and product fit. | Later review or reject. |
| Relationship level-up | Ch. 6 pp. 138-139 | candle/words rite | ritual_candidate | adult_intimacy, exact_text_sensitive | candlelight, words | opening, marking | duplicate_existing_candidate | yes for control framing | Existing record covers the milestone logic; avoid coercive framing. | Metadata review later. |
| Honey jar / compassion work | Ch. 6 pp. 139-140 | jar/sweetening rite | ritual_candidate | adult_intimacy, coercive_or_target_control, exact_text_sensitive | vessel, words | blessing, tending | duplicate_existing_candidate | yes for control framing | Existing record is safe only if framed as softening care, not controlling someone. | Metadata/recommendation review later. |
| Love necromancy / relationship revival | Ch. 6 pp. 140-141 | spell | possible_candidate | coercive_or_target_control, therapy_adjacent, house_voice_challenge | candlelight, words | opening, connecting | hold_before_import | yes | Source lane is visible but pressure/control risk is high. | Decide reject or source-note-only. |
| Three-month marker and moving-in rites | Ch. 6 pp. 142-145 | milestone rite | ritual_candidate | adult_intimacy, exact_text_sensitive | table, words, vessel | marking, blessing | duplicate_existing_candidate | no | Existing records cover the milestone/home transition. | No new import. |
| Wedding / commitment doll work | Ch. 6 pp. 147-148 | object rite | possible_candidate | adult_intimacy, exact_text_sensitive, house_voice_challenge | table, words | marking, blessing | candidate_extract_later | yes | Could be a commitment marker, but was not source-safely authored here. | Later candidate or hold. |
| Sex worker protection prayer | Ch. 7 pp. 154-155 | prayer | possible_candidate | cultural_or_gender_load, exact_text_sensitive, house_voice_challenge | words, candlelight | protecting, blessing | hold_before_import | yes | Community-specific prayer needs product/voice review before app content. | Decide reject, source-note-only, or later private review. |
| Former-lover release | Ch. 7 pp. 150-153 | release rite | ritual_candidate | adult_intimacy, consent_sensitive, therapy_adjacent | words, candlelight | releasing, protecting | duplicate_existing_candidate | no | Existing record is complete and source-backed. | No new import. |
| Friendship-with-benefits boundary | Ch. 7 pp. 152-153 | boundary rite | ritual_candidate | adult_intimacy, explicit, consent_sensitive, recommendation_lane_unclear | vessel, words, body | connecting, protecting | duplicate_existing_candidate | yes for split | Existing vessel+connecting record exists; a body variant would be a product split. | Decide later if wanted. |
| Exes-be-gone / digital boundary / dating app lanes | Ch. 7 pp. 153-165 | boundary/protection | mixed | adult_intimacy, consent_sensitive, therapy_adjacent, house_voice_challenge | words, candlelight, body | protecting, releasing | mixed_duplicate_and_hold | yes for held rows | Some are imported safely; some are context-specific advice/protection lanes. | Later line-by-line direct-use review if needed. |
| Uncrossing / light-shield protection | Ch. 7 pp. 155-165 | protection rite | ritual_candidate | adult_intimacy, consent_sensitive, therapy_adjacent | words, candlelight, body | protecting, releasing | duplicate_existing_candidate | no | Existing protection/light-shield records cover the source-safe ritual shape. | No new import. |
| Psychic vampire / energy-drain boundary lane | Ch. 7 pp. 160-165 | protection / boundary | possible_candidate | therapy_adjacent, house_voice_challenge, exact_text_sensitive | words, body, candlelight | protecting, releasing | candidate_extract_later | yes | Source lane is visible but needs house-voice and product-boundary handling before becoming app content. | Later source-safe boundary candidate or source-note-only. |
| Legal action / sexual health / secrecy / abuse-adjacent protection | Ch. 7 pp. 157-160 | protection | possible_candidate | medical_or_somatic_claim, therapy_adjacent, coercive_or_target_control, house_voice_challenge | words, candlelight, vessel | protecting, releasing | hold_before_import | yes | Product/medical/legal/trauma boundaries block mechanical import. | Likely reject app text; keep source-visible. |
| Chapter 8 mirror-bed banishing / identity-protection hex lanes | Ch. 8 pp. 166-169 | hex / protection | possible_candidate | coercive_or_target_control, house_voice_challenge, exact_text_sensitive | candlelight, body, words | protecting, releasing | hold_before_import | yes | Some ritual architecture exists, but chapter frame and exact-source handling need Tim decision. | Decide reject, source-note-only, or mechanics-only salvage. |
| Chapter 8 money/rebound/revenge attraction lanes | Ch. 8 pp. 169-171 | spell / recipe | possible_candidate | coercive_or_target_control, explicit, sex_forward, body_fluid, medical_or_somatic_claim | vessel, body, candlelight | opening, protecting | reject_product_boundary | yes | Targeted/revenge/body-fluid recipe handling blocks import. | Name only; do not import from this packet. |
| Chapter 8 slut-shamer / psychic truth / breakup courage lanes | Ch. 8 pp. 171-174 | spell / tarot / fire rite | possible_candidate | coercive_or_target_control, exact_text_sensitive, house_voice_challenge | words, candlelight, table | protecting, releasing, voicing | hold_before_import | yes | Some mechanics resemble boundary/release work, but revenge frame and exact-text sensitivity are unresolved. | Decide mechanics-only non-revenge salvage vs reject. |
| Chapter 8 assault/revenge jar / karma / cemetery-fruit lanes | Ch. 8 pp. 175-177 | hex / revenge | possible_candidate | coercive_or_target_control, therapy_adjacent, exact_text_sensitive, house_voice_challenge | vessel, plant, words | protecting, releasing | reject_product_boundary | yes | Strong revenge/trauma boundary. Visible in inventory, not import-ready. | Final reject or source-note-only decision later. |
| Breakup boldness | Ch. 9 pp. 178-180 | glamour / courage rite | ritual_candidate | adult_intimacy, therapy_adjacent | body, words | opening, releasing | duplicate_existing_candidate | no | Existing record covers breakup courage/boldness. | No new import. |
| Relationship mending and trust | Ch. 9 pp. 180-183 | mending rite | ritual_candidate | adult_intimacy, therapy_adjacent, exact_text_sensitive | words, candlelight, vessel | tending, connecting | duplicate_existing_candidate | yes for recommendation posture | Existing records exist; recommendation eligibility may need care. | Review recommendation posture later. |
| Bed reset / linen cleansing | Ch. 9 pp. 183-184 | cleansing rite | ritual_candidate | adult_intimacy, therapy_adjacent | body, vessel, plant | releasing, steadying | duplicate_existing_candidate | no | Existing `candidate.saint_thomas.bed_linen_reset` covers this. | No new import. |
| Home/body after intimacy reset | Ch. 9 pp. 188-189 | cleansing rite | ritual_candidate | adult_intimacy, explicit, sex_forward | body, vessel | steadying, releasing | duplicate_existing_candidate | no | Existing `candidate.saint_thomas.home_after_intimacy_reset` covers this. | No new import. |
| Assault survivor / cheating / gaslighting lanes | Ch. 9 pp. 185-192 | prayer / clarity / recovery | possible_candidate | therapy_adjacent, exact_text_sensitive, house_voice_challenge | words, candlelight, body | protecting, releasing, tending | hold_before_import | yes | Source lanes are visible, but therapy/trauma product decisions and exact-text review are required. | Decide reject, source-note-only, or private direct-source-only. |
| Body smoke / enemy bath bomb / smoke/body purification lanes | Ch. 9 pp. 189-191 | smoke / bath / revenge | possible_candidate | explicit, body_fluid, medical_or_somatic_claim, coercive_or_target_control | body, vessel, plant | releasing, protecting | reject_product_boundary | yes | Recipe/revenge/body-fluid handling blocks import. | Name only; do not import from this packet. |
| Remove cynicism / forgive self | Ch. 9 pp. 192-194 | closing / repair rite | ritual_candidate | therapy_adjacent, exact_text_sensitive | words, candlelight | tending, releasing | duplicate_existing_candidate | no | Existing records cover this source-safe repair lane. | No new import. |
...
New self-contained import-ready candidates found: 7
Candidates marked approved_for_mechanical_import: 7
Rows that remain visible but are not approved for import: 78
...
Candidates with body-fluid metadata: 1 approved_for_mechanical_import; additional body-fluid/revenge/recipe lanes inventoried but held or rejected
...
- 7 rows are `approved_for_mechanical_import` and have complete candidate records below.
- 78 rows are intentionally not approved for import from this packet. They remain visible as duplicates, metadata-repair lanes, source notes, holds, later-candidate lanes, architectural rejects, or product-boundary rejects.
- The 75 existing candidates reconsidered are the 28 Anand records and 47 Saint Thomas records already present in the baseline packets/runtime collection. Existing candidates are not duplicated as new imports unless a distinct source-backed Ritual form was missing.
- This packet's job is extraction and disposition, not maximizing imports. A complete extraction can honestly produce many visible rows with no mechanical-import record.
...
The complete held/deferred/duplicate surface is the 85-row ledger above. This section preserves the decision logic without repeating the whole table.

| Status family | Meaning in this packet | Examples |
| --- | --- | --- |
| `duplicate_existing_candidate` | Source lane is real and already represented by a runtime/imported candidate, so this packet should not create another Ritual. | Anand practice cadence, Saint Thomas fantasy apple, former-lover release, bed reset. |
| `metadata_repair_needed` | Existing Ritual is complete, but its primary carrier/purpose may not match the source's strongest body/connecting logic. | Anand Melting Hug, Anand Heart Salutation. |
| `source_note_only` / `source_support_for_approved_candidate` | Material informs extraction but is not itself a standalone Ritual. | Anand boundaries, Saint Thomas Chapter 2 glossary, Saint Thomas body-fluid correspondences. |
| `candidate_extract_later` | Ritual architecture is plausible, but this pass does not safely author a complete runtime-compatible candidate. | Anand inner magician initiation, Saint Thomas gender identity rite, Saint Thomas psychic vampire boundary. |
| `hold_before_import` | Source-visible lane may be usable, but needs Tim/product decision before app-content import. | Anand sexual power objects, Anand chakra lanes, Saint Thomas Chapter 8 mirror-bed/hex lanes. |
| `reject_architectural` | Source content is visible and may be valuable, but it is not a self-contained Moon & Table Ritual. | Saint Thomas Chapter 2 education, Anand explicit technique lessons, Saint Thomas anal technique. |
| `reject_product_boundary` | Source content has ritual or recipe shape, but current product/material/targeting boundaries block mechanical import from this packet. | Saint Thomas psychoactive/topical recipes, obsession oil, Chapter 8 revenge/rebound/body-fluid recipe lanes. |
