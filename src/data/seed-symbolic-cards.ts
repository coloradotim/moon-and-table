...
export const seedSymbolicCards: SymbolicCard[] = [
  {
    ...
    title: "New Moon",
    category: "moon_phase",
    summary: "A quiet reset point for naming one intention or beginning with less noise.",
    themes: ["beginning", "reset", "intention", "quiet"],
    good_for: ["choosing one small focus", "starting gently", "clearing mental clutter"],
    ritual_styles: ["reflection", "candle", "journal", "simple planning"],
    ritual_ideas: [
      "Write one sentence about what the household wants to make room for.",
      "Light a candle briefly and name one simple next step.",
    ],
    avoid_saying: [
    ...
    safety_notes: ["Use ordinary candle safety if lighting a candle."],
    source_references: ["docs/source-review-packets.md#2-moon-phase-reference-set"],
    confidence: "core",
  ...
  },
  {
    ...
    title: "Waxing Moon",
    category: "moon_phase",
    summary: "A building phase for adding one bit of care, attention, or follow-through.",
    themes: ["growth", "practice", "momentum", "support"],
    good_for: ["small progress", "tending a plan", "adding support to something already started"],
    ritual_styles: ["plant tending", "kitchen", "planning", "care task"],
    ritual_ideas: [
    ...
    safety_notes: ["Keep plant and kitchen actions practical, brief, and allergy-aware."],
    source_references: ["docs/source-review-packets.md#2-moon-phase-reference-set"],
    confidence: "core",
    approval_status: "approved",
  },
  {
    ...
    title: "Full Moon",
    category: "moon_phase",
    summary: "A visible point in the cycle for noticing what is clear, complete, or asking for attention.",
    themes: ["visibility", "completion", "illumination", "gratitude"],
    good_for: ["noticing what is present", "marking completion", "sharing appreciation"],
    ritual_styles: ["reflection", "candle", "conversation prompt", "gratitude"],
    ritual_ideas: [
      "Name one thing that has become clearer lately.",
      "Set a glass of water nearby and write down one completed effort to acknowledge.",
    ],
    avoid_saying: [
    ...
    safety_notes: ["Use fire-free options when energy is high, space is busy, or candle safety is uncertain."],
    source_references: ["docs/source-review-packets.md#2-moon-phase-reference-set"],
    confidence: "core",
    approval_status: "approved",
  },
  {
    ...
    title: "Waning Moon",
    category: "moon_phase",
    summary: "A settling phase for releasing one small burden, clearing space, or integrating what happened.",
    themes: ["release", "clearing", "integration", "rest"],
    good_for: ["letting one thing go", "small cleanup", "closing a loop", "resting after effort"],
    ritual_styles: ["kitchen clearing", "plant tending", "reflection", "gentle cleanup"],
    ritual_ideas: [
    ...
    safety_notes: ["Keep clearing rituals physically light and avoid stirring dust or scents if sensitivity is possible."],
    source_references: ["docs/source-review-packets.md#2-moon-phase-reference-set"],
    confidence: "core",
    approval_status: "approved",
  },
