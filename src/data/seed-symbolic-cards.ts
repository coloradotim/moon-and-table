...
export const seedSymbolicCards: SymbolicCard[] = [
  ...
  {
    id: "card_plant_magic_houseplant",
    key: "houseplant",
    title: "Houseplant",
    category: "plant_magic",
    summary: "A living-home cue for observation, care, light, water, and noticing what is actually needed.",
    themes: ["observation", "care", "living rhythm", "attention"],
    good_for: ["checking one living thing", "practical tending", "low-overwhelm care"],
    ritual_styles: ["plant", "plant tending", "home care", "observation"],
    ritual_ideas: [
      "Check one reviewed houseplant for soil, leaves, light, and access before acting.",
      "Let the plant be a cue to notice one living need without adding a bigger task.",
    ],
    avoid_saying: [
      "Do not require touching a plant when safety is uncertain.",
      "Do not imply plant health reflects household worth.",
      "Do not recommend buying a new plant.",
    ],
    safety_notes: [
      "Use only with plants reviewed for pet, child, allergy, and handling safety.",
      "When plant safety is uncertain, choose observation without contact.",
    ],
    safety_flags: withSafetyOverrides({
      pets: "review_required",
      children: "supervision",
      allergies: ["review plant allergies and irritants before recommending contact"],
      cleanupBurden: "tiny",
    }),
    signalSummary: "A houseplant can support practical observation and gentle care.",
    ritualPatternKeys: ["houseplant_check_in", "tend_one_plant"],
    sourceNoteKeys: [
    ...
    contraindications: ["avoid contact when plant safety, pet access, or allergies are uncertain"],
    source_references: [
      "source.arin_murphy_hiscock",
      "source.aspca_plant_safety",
      "source.vca_pet_plant_safety",
  ...
  },
  {
    ...
    title: "Basil",
    category: "herb",
    summary: "An ordinary kitchen-herb symbol for welcome, warmth, and everyday household care.",
    themes: ["welcome", "warmth", "care", "kitchen"],
    good_for: ["softening household tone", "small kitchen cues", "welcoming attention"],
    ritual_styles: ["kitchen", "herb", "warmth", "home care"],
    ritual_ideas: [
      "Use a basil jar, label, or already-safe sprig as a cue for one welcoming household action.",
      "Name one small way to make the kitchen feel easier to return to.",
    ],
    avoid_saying: [
      "Do not make prosperity or attraction claims.",
      "Do not suggest medicinal use.",
      "Do not assume herbs are safe for every household.",
    ],
    safety_notes: [
      "Ordinary kitchen use only; no supplements, oils, smoke, or health claims.",
      "Review pet access, allergies, pregnancy considerations, and food fit before contact.",
    ],
    safety_flags: withSafetyOverrides({
      ingestion: "avoid",
      essentialOils: "avoid",
      ...
      pets: "review_required",
      pregnancy: "review_required",
      allergies: ["review basil allergies and household food fit before recommending contact"],
      cleanupBurden: "tiny",
    }),
    signalSummary: "Basil can add a warm kitchen-care accent.",
    ritualPatternKeys: ["basil_kitchen_warmth_cue"],
    sourceNoteKeys: [
    ...
    toneGuidance: ["warm", "ordinary", "welcoming"],
    contraindications: ["avoid when herb safety, allergies, or pet access are uncertain"],
    source_references: [
      "source.laurel_woodward",
      "source.fda_food_safety",
      "source.aspca_plant_safety",
  ...
  },
  {
    ...
    title: "Mint",
    category: "herb",
    summary: "An ordinary kitchen-herb cue for freshness, clear attention, and lightening the household tone.",
    themes: ["freshness", "clarity", "lightness", "kitchen"],
    good_for: ["fresh-start accents", "naming one clear next step", "small kitchen resets"],
    ritual_styles: ["kitchen", "herb", "freshness", "reflection"],
    ritual_ideas: [
      "Use a mint jar, label, or already-safe sprig as a cue to name one thing that can feel fresher.",
      "Pair mint symbolism with clearing one small kitchen item and stopping there.",
    ],
    avoid_saying: [
      "Do not make digestive, energy, or therapeutic claims.",
      "Do not require drinking mint tea.",
      "Do not assume herbs are safe for every household.",
    ],
    safety_notes: [
      "Ordinary kitchen use only; no supplements, oils, smoke, or health claims.",
    ...
    safety_flags: withSafetyOverrides({
      ...
      pets: "review_required",
      pregnancy: "review_required",
      allergies: ["review mint allergies and household food fit before recommending contact"],
      cleanupBurden: "tiny",
    }),
    signalSummary: "Mint can add a light freshness accent.",
    ritualPatternKeys: ["mint_freshness_cue"],
    sourceNoteKeys: [
    ...
    toneGuidance: ["fresh", "light", "plain"],
    contraindications: ["avoid when herb safety, allergies, or pet access are uncertain"],
    source_references: [
      "source.laurel_woodward",
      "source.fda_food_safety",
  ...
  },
  {
    ...
    title: "Thyme",
    category: "herb",
    summary: "An ordinary kitchen-herb symbol for steadiness, patience, and durable care.",
    themes: ["steadiness", "patience", "care", "kitchen"],
    good_for: ["slow practical support", "small repair cues", "staying with one bounded action"],
    ritual_styles: ["kitchen", "herb", "steady care", "home care"],
    ritual_ideas: [
      "Use a thyme jar, label, or already-safe sprig as a cue to choose one steady household action.",
      "Name one thing that can be made easier without turning it into a large task.",
    ],
    avoid_saying: [
      "Do not claim thyme creates courage or endurance.",
      "Do not suggest medicinal use.",
      "Do not assume herbs are safe for every household.",
    ],
    safety_notes: [
    ...
    safety_flags: withSafetyOverrides({
      ...
      pets: "review_required",
      pregnancy: "review_required",
      allergies: ["review thyme allergies and household food fit before recommending contact"],
      cleanupBurden: "tiny",
    }),
    signalSummary: "Thyme can add a steady-care accent.",
    ritualPatternKeys: ["thyme_steady_care_cue"],
    sourceNoteKeys: [
  ...
  },
  {
    ...
    title: "Sage",
    category: "herb",
    summary: "An ordinary kitchen-herb symbol for clear reflection, used without smoke practices.",
    themes: ["reflection", "clarity", "discernment", "kitchen"],
    good_for: ["naming one clear thing", "careful reflection", "simple kitchen symbolism"],
    ritual_styles: ["kitchen", "herb", "reflection", "low woo"],
    ritual_ideas: [
      "Use a sage jar, label, or already-safe kitchen herb as a cue to name one clear thought.",
      "Set aside smoke language and choose one ordinary next step instead.",
    ],
    avoid_saying: [
      "Do not recommend burning herbs.",
      "Do not use smoke-clearing or purification claims.",
      "Do not suggest medicinal use.",
    ],
    safety_notes: [
      "Ordinary kitchen use only; no smoke, supplements, oils, or health claims.",
      "Review pet access, allergies, pregnancy considerations, and food fit before contact.",
    ],
    safety_flags: withSafetyOverrides({
      ingestion: "avoid",
      ...
      pets: "review_required",
      pregnancy: "review_required",
      culturalContext: "label_required",
      allergies: ["review sage allergies and household food fit before recommending contact"],
      cleanupBurden: "tiny",
    }),
    signalSummary: "Sage can add a clear-reflection accent without smoke.",
    ritualPatternKeys: ["sage_clear_reflection_cue"],
    sourceNoteKeys: [
    ...
    contraindications: ["avoid smoke practices and unreviewed herb safety"],
    source_references: [
      "source.scott_cunningham_cross_check",
      "source.fda_food_safety",
      "source.aspca_plant_safety",
  ...
  {
    id: "card_herb_lavender",
    key: "lavender",
    title: "Lavender",
    category: "herb",
    summary: "An ordinary household herb cue for softness, rest, and lowering intensity without health claims.",
    themes: ["softness", "rest", "gentleness", "lower intensity"],
    good_for: ["rest cues", "softening tone", "ending a small action"],
    ritual_styles: ["herb", "rest", "reflection", "home care"],
    ritual_ideas: [
      "Use a lavender label, image, or already-safe household item as a cue to lower intensity.",
      "Name one thing that can wait without turning rest into a requirement.",
    ],
    avoid_saying: [
      "Do not promise sleep, calm, or relief.",
      "Do not recommend essential oils.",
      "Do not assume scent is welcome or safe.",
    ],
    safety_notes: [
      "Use scent-free or visual cues when allergies, scent sensitivity, pets, or children are a concern.",
      "No supplements, oils, smoke, or health claims.",
    ],
    safety_flags: withSafetyOverrides({
      ingestion: "avoid",
      essentialOils: "avoid",
      ...
      pets: "review_required",
      pregnancy: "review_required",
      allergies: ["review lavender allergies, scent sensitivity, and household fit before contact"],
      cleanupBurden: "tiny",
    }),
    signalSummary: "Lavender can add a soft rest accent.",
    ritualPatternKeys: ["lavender_soft_rest_cue"],
    sourceNoteKeys: [
    ...
    contraindications: ["avoid scent, oils, and contact when allergies or pet access are uncertain"],
    source_references: [
      "source.laurel_woodward",
      "source.fda_food_safety",
      "source.aspca_plant_safety",
