...
export const starterSourceReviews: SourceReview[] = [
  ...
  {
    id: "source.vca_pet_plant_safety",
    title: "VCA pet and plant safety references",
    authorOrPublisher: "VCA Animal Hospitals",
    category: "ritual_safety",
    sourceType: "safety_reference",
    useDecision: "use",
    reviewStatus: "approved",
    bestFor: ["cross-checking pet-access, plant, and herb caution categories"],
    concerns: ["check directly before naming plant-specific safety claims"],
    copyrightNotes: ["cite public reference family; do not paste passages"],
    safetyNotes: ["uncertain plant and herb safety should block casual pet-access recommendations"],
    culturalContextNotes: [],
    extractionNotes: ["extract pet and plant review categories only"],
    confidence: "high",
  },
  {
    id: "source.safety_reference_families",
    title: "FDA / CDC / ASPCA / VCA / Poison Control / NFPA safety references",
...
const starterSourceNoteSeeds: SourceNote[] = [
  ...
  {
    id: "note.houseplant_observation_first",
    sourceId: "source.arin_murphy_hiscock",
    locationNote: "docs/source-research-synthesis.md plant and kitchen-herb expansion",
    paraphrasedNote:
      "A houseplant cue should begin with observation and actual care needs, not with treating the plant as a prop.",
    category: "plant_magic",
    tags: ["houseplant", "observation", "care"],
    riskNotes: ["avoid forcing plant handling or making plant care symbolic only"],
    safetyNotes: ["pet, child, allergy, and plant safety review come first"],
    copyrightNotes: ["short transformed note only; no copied plant ritual text"],
    verbatimAllowed: false,
  },
  {
    id: "note.basil_kitchen_warmth",
    sourceId: "source.laurel_woodward",
    locationNote: "docs/source-research-synthesis.md plant and kitchen-herb expansion",
    paraphrasedNote:
      "Basil can be treated as an ordinary kitchen-herb cue for welcome, warmth, and everyday household care.",
    category: "kitchen_plant_magic",
    tags: ["basil", "herb", "warmth"],
    riskNotes: ["avoid prosperity, health, or spell-result claims"],
    safetyNotes: ["normal food use only; allergies and pet access override symbolism"],
    copyrightNotes: ["short transformed note only; no copied correspondence list"],
    verbatimAllowed: false,
  },
  {
    id: "note.mint_freshness_clear",
    sourceId: "source.laurel_woodward",
    locationNote: "docs/source-research-synthesis.md plant and kitchen-herb expansion",
    paraphrasedNote:
      "Mint can work as a simple kitchen cue for freshness, alertness of attention, and a lighter household tone.",
    category: "kitchen_plant_magic",
    tags: ["mint", "herb", "freshness"],
    riskNotes: ["avoid digestive, energy, or therapeutic claims"],
    safetyNotes: ["normal food use only; allergies and pet access override symbolism"],
    copyrightNotes: ["short transformed note only; no copied correspondence list"],
    verbatimAllowed: false,
  },
  {
    id: "note.thyme_steady_care",
    sourceId: "source.scott_cunningham_cross_check",
    locationNote: "docs/source-research-synthesis.md plant and kitchen-herb expansion",
    paraphrasedNote:
      "Thyme can be used as a cross-checked ordinary herb symbol for steadiness, patience, and durable care.",
    category: "kitchen_plant_magic",
    tags: ["thyme", "herb", "steadiness"],
    riskNotes: ["avoid courage guarantees, medicinal use, or correspondence certainty"],
    safetyNotes: ["normal food use only; allergies and pet access override symbolism"],
    copyrightNotes: ["short transformed note only; no copied correspondence list"],
    verbatimAllowed: false,
  },
  {
    id: "note.sage_clear_reflection_no_smoke",
    sourceId: "source.scott_cunningham_cross_check",
    locationNote: "docs/source-research-synthesis.md plant and kitchen-herb expansion",
    paraphrasedNote:
      "Sage may be used as an ordinary kitchen-herb symbol for clear reflection only when smoke practices are excluded.",
    category: "kitchen_plant_magic",
    tags: ["sage", "herb", "reflection", "no_smoke"],
    riskNotes: ["avoid smoke-clearing language, medicinal claims, and cultural borrowing"],
    safetyNotes: ["normal food use only; no smoke, oils, or pet-access assumptions"],
    copyrightNotes: ["short transformed note only; no copied correspondence list"],
    verbatimAllowed: false,
  },
  {
    id: "note.lavender_soft_rest_cue",
    sourceId: "source.laurel_woodward",
    locationNote: "docs/source-research-synthesis.md plant and kitchen-herb expansion",
    paraphrasedNote:
      "Lavender can be framed as a soft rest cue or visual/scent-free symbol without promising sleep, calm, or health effects.",
    category: "kitchen_plant_magic",
    tags: ["lavender", "herb", "rest"],
    riskNotes: ["avoid sleep, anxiety, or medical claims"],
    safetyNotes: ["normal household use only; allergies, scent sensitivity, and pets override symbolism"],
    copyrightNotes: ["short transformed note only; no copied correspondence list"],
    verbatimAllowed: false,
  },
  {
  ...
  {
    id: "note.vca_pet_plant_allergy_guardrail",
    sourceId: "source.vca_pet_plant_safety",
    locationNote: "docs/source-research-synthesis.md plant and kitchen-herb expansion",
    paraphrasedNote:
      "When plant or herb safety is uncertain, choose observation or a non-contact cue instead of touching, moving, burning, or leaving material accessible.",
    category: "ritual_safety",
    tags: ["pet", "plant", "herb", "allergy", "safety"],
    riskNotes: ["avoid casual plant access around pets, children, or sensitivities"],
    safetyNotes: ["uncertain plant and herb access is review-required"],
    copyrightNotes: ["short transformed safety note only; no copied safety passage"],
    verbatimAllowed: false,
  },
  {
