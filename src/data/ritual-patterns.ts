...
export const starterRitualPatterns: RitualPattern[] = [
  ...
  },
  {
    ...
    sourceNoteKeys: ["note.plant_tending_check_first", "note.pet_plant_access_review"],
  ...
  },
  {
    ...
    safetyFlags: withSafetyOverrides({ pets: "review_required", children: "supervision", cleanupBurden: "tiny" }),
    safetyNotes: [
