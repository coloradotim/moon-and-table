...
function getCompressedLineage(pattern: RitualPattern): string | undefined {
  const lineageByPattern: Record<string, string> = {
    ...
    first_light_for_the_beginning: "first-light and observable-light timing logic",
    candle_witness_one_phrase: "observable full-light timing and hearth/table witness logic",
    unlit_candle_witness: "candle witness and no-flame household light logic",
    window_light_threshold: "first-light threshold and observable-light timing logic",
    waning_light_release: "waning lunar visibility and household light-lowering logic",
    full_light_holding_bowl: "table light and bounded vessel-holding logic",
