...
export const PROFILE_PREFERENCE_OPTIONS = [
  ...
  { value: "houseplant", label: "Houseplant", group: "action_pattern" },
  ...
  { value: "herb", label: "Herb", group: "action_pattern" },
  { value: "basil", label: "Basil", group: "action_pattern" },
  { value: "mint", label: "Mint", group: "action_pattern" },
  { value: "thyme", label: "Thyme", group: "action_pattern" },
  { value: "sage", label: "Sage", group: "action_pattern" },
  { value: "lavender", label: "Lavender", group: "action_pattern" },
